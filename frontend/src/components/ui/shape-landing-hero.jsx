            ...
            <motion.div
                ...
                <div
                    className={cn(
                        ...
                        gradient,
                        "backdrop-blur-[2px] border-2 border-black/30",
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <p
                            className="text-base sm:text-lg md:text-xl text-black/60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Take control of your finances with Fincrate, where real-time insights and intuitive tools empower you to invest with confidence.
                        </p>
                    </motion.div>
                </div>
            </div>
            <div
                className="absolute inset-0 bg-gradient-to-t from-white via-transparent to-white/80 pointer-events-none" />
        </div>
    );
}
